  ...
  return (
    ...
    >
      <p className="text-sm text-neutral-600">
        Book as a guest — you can save this booking to an account after payment.
      </p>
      ...
      <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-between">
        ...
        <Button type="submit" data-testid="book-details-continue">
          Continue to summary
        </Button>
      </div>
    </form>
